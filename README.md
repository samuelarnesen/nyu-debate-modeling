...
* **run_ppo.py**: Kicks off a PPO training run. The configuration for the training run is set in `train/configs/ppo_config.yaml`. Example usage: `python3 scripts/run_ppo.py --configuration='Train - 13B - Alpaca' --train_type='ppo'`
